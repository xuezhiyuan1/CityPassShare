...
public class NvAdapter extends RecyclerView.Adapter<NvAdapter.ViewHolder> {
    ...
    private List<NvBean.ServerInfoBean.NewTCoverInfoListBeanX.NewTCoverInfoListBean> data;

    public NvAdapter(List<NvBean.ServerInfoBean.NewTCoverInfoListBeanX.NewTCoverInfoListBean> data) {
        this.data = data;
    }

    @Override
    public NvAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        NvAdapter.ViewHolder holder = new NvAdapter.ViewHolder(View.inflate(App.activity, R.layout.zuixin_item, null));
        return holder;
    }
