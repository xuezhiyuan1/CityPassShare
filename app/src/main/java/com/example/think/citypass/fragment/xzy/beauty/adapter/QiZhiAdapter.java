...
public class QiZhiAdapter extends RecyclerView.Adapter<QiZhiAdapter.ViewHolder> {

private List<QIzhiBean.ServerInfoBean.NewTCoverInfoListBeanX.NewTCoverInfoListBean> data;

public QiZhiAdapter(List<QIzhiBean.ServerInfoBean.NewTCoverInfoListBeanX.NewTCoverInfoListBean> data) {
        this.data = data;
        }

@Override
public QiZhiAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        QiZhiAdapter.ViewHolder holder = new QiZhiAdapter.ViewHolder(View.inflate(App.activity, R.layout.zuixin_item, null));
        return holder;
        }
