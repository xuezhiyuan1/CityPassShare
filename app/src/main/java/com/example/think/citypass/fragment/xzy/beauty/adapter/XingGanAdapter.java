...
public class XingGanAdapter extends RecyclerView.Adapter<XingGanAdapter.ViewHolder> {

    private List<XingGanBean.ServerInfoBean.NewTCoverInfoListBeanX.NewTCoverInfoListBean> data;

    public XingGanAdapter(List<XingGanBean.ServerInfoBean.NewTCoverInfoListBeanX.NewTCoverInfoListBean> data) {
        this.data = data;
    }

    @Override
    public XingGanAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        XingGanAdapter.ViewHolder holder = new XingGanAdapter.ViewHolder(View.inflate(App.activity, R.layout.zuixin_item, null));
        return holder;
    }
