...
public class YoutaiduFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        ImageView image = (ImageView) headView.findViewById(R.id.image_haveTaiDu);
        image.setImageDrawable(getResources().getDrawable(R.drawable.news_topimage3));
        datas = new ArrayList<>();
    ...
    protected void loadData() {
        ...
        map.put("param",dataCreatParams(1));
