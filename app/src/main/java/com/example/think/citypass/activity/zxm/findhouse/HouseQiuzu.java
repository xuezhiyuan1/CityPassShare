...
import com.example.think.citypass.activity.zxm.webview.WebViewUtils;
...
public class HouseQiuzu  extends BaseActivity {
    String url="http://m.yanqing.ccoo.cn/post/fangwu/fc_qiuzu.aspx";
    WebView  webView;
