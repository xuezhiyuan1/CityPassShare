...
public class Util {
	...
	public List<com.example.think.citypass.activity.zxm.upphoto.logic.FileTraversal> LocalImgFileList(){
		List<com.example.think.citypass.activity.zxm.upphoto.logic.FileTraversal> data=new ArrayList<com.example.think.citypass.activity.zxm.upphoto.logic.FileTraversal>();
		String filename="";
		...
		if (allimglist!=null) {
			...
			for (int i = 0; i < str.length; i++) {
				filename=str[i];
				com.example.think.citypass.activity.zxm.upphoto.logic.FileTraversal ftl= new com.example.think.citypass.activity.zxm.upphoto.logic.FileTraversal();
	...
	public void imgExcute(ImageView imageView, com.example.think.citypass.activity.zxm.upphoto.logic.ImgCallBack icb, String... params){
	...
	public class LoadBitAsynk extends AsyncTask<String, Integer, Bitmap>{
		...
		ImageView imageView;
		com.example.think.citypass.activity.zxm.upphoto.logic.ImgCallBack icb;
